...
public:
    ...
    Dev(int id, const std::string& name, double salary, const std::string& language, const std::string& level) : Emp(id, name, salary) {
    ...
    static std::shared_ptr<Dev> createFromInput() {
        ...
        while (!errflag) {
            ...
            if (language == "c++" || language == "c" || language == "php" || language == "c#" || language == "js" || language == "go") {
                errflag = true;
            }
            else {
                fastErrInfo;
...
public:
    ...
    Mgr(int id, const std::string& name, double salary, int members, T averagesalary) : Emp(id, name, salary) {
    ...
    double calculateSalary() const override {
        double bonus = GetMembers() * GetAverageSalary() * 0.01;
        return GetSalary() + bonus;
    }
...
public:
    ...
    Dsgnr(int id, const std::string& name, double salary, const std::string& designTool, bool isUX) : Emp(id, name, salary) {
...
public:
    ...
    QAEng(int id, const std::string& name, double salary, const std::string& testingType, bool isAutomation) : Emp(id, name, salary) {
